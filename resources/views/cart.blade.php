                    ...
                    <tr>
                        <td>
                            <a href="../product/details.html">
                                <img src="{{url('../assets/images/logo.png" class="h-logo img-fluid blur-up lazyload')}}" class="blur-up lazyloaded"
                                     alt="">
                            </a>
                        </td>
                        <td>
                            ...
                            <div class="cart-box-details">
                                <div class="total-details">
                                    <div class="top-details">
                                        <h3>Cart Totals</h3>
                                        <h6>Sub Total <span>${{Cart::instance('cart')->subtota()}}</span></h6>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <img src="{{url('assets/images/newletter-icon.png')}}" class="img-fluid blur-up lazyload" alt="">
                    ...
                    <div>
                        ...
                        <div class="modal-product">
                            <div class="modal-contain-img">
                                <img src="{{url('assets/images/fashion/instagram/4.jpg')}}" class="img-fluid blur-up lazyload"
                                     alt="">
                            </div>
                                    ...
                                    <div>
                                        <div class="product-box">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="details.php">
                                                        <img src="{{url('assets/images/fashion/product/front/1.jpg')}}"
                                    ...
                                    <div>
                                        <div class="product-box">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="details.php">
                                                        <img src="{{url('assets/images/fashion/product/front/2.jpg')}}"
                                                             class="bg-img blur-up lazyload" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        <div class="product-box">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="details.php">
                                                        <img src="{{url('assets/images/fashion/product/front/3.jpg')}}"
                                                             class="bg-img blur-up lazyload" alt="">
                                                    </a>
                                                </div>
                                            </div>
